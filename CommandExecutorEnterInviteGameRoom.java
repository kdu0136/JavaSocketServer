...
//방 입장 명령 실행자
public class CommandExecutorEnterInviteGameRoom implements CommandExecutor {	
	/**********************************
	...
	**********************************/
	public void execute(String request, ClientHandler clientHandler) throws Exception {
        ...
        String jsonStr = JsonEncode.getInstance().encodeCommandJson("enterInviteGameRoomResult", keys, values); //방 입장을 요청한 클라이언트에게 결과를 보냄
